...
export default function About() {
    ...
    return (
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'white' }}>
            <View style={{ width: '100%', height: 200, paddingHorizontal: 30 }}>
                <Image source={require('../../assets/images/logo.png')} resizeMode="contain" style={{ width: '100%', height: '100%' }} />
            </View>
            <Text style={{ fontSize: 18, fontWeight: 'bold', textAlign: 'center' }}>Version 1.2.1</Text>
            <TouchableOpacity onPress={check} style={{ marginTop: 20}}>
                {!checking && <Text>Check for update</Text>}
                {checking && <ActivityIndicator color={theme.primaryColor} size="large" />}
            </TouchableOpacity>
        </View>
    )
}
